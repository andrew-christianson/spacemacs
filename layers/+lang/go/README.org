...
If you're using go-guru, insure that is available as well:

#+BEGIN_SRC sh
  go get -u -v golang.org/x/tools/cmd/guru
#+END_SRC

Make sure that =gocode=, and =oracle= (or =guru=) executables are in your PATH. For information about
...
By default, =go-oracle= is used to provide code analysis for go.  To use
=go-guru= instead:

#+BEGIN_SRC emacs-lisp
  (go :variables go-use-go-guru t)
#+END_SRC
...
| ~SPC m r v~ | go-guru expand region                                    |
